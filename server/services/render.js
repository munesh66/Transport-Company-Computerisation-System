...
axios.get("https://transport-company-atul.herokuapp.com/api/users")
...
exports.update_truck = (req, res) =>{
    axios.get('https://transport-company-atul.herokuapp.com/api/users', { params : { id : req.query.id }})
...
exports.viewManager=(req,res)=>{
    axios.get('https://transport-company-atul.herokuapp.com/api/manager')
        .then(function(response){
